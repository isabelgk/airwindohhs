...
namespace airwindohhs::zhighpass2 {

constexpr std::string_view k_name{ "ZHighpass2" };
...
template <typename T>
class ZHighpass2 final : public Effect<T>
{
    double iirSampleAL;
    double iirSampleAR;
    enum
  ...
  public:
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        biquadA[biq_freq] = ((pow(B, 4) * 9500.0) / Effect<T>::getSampleRate()) + 0.00076;
