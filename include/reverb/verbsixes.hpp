...
template <typename T>
class VerbSixes final : public Effect<T>
{
#ifdef THREEBYTHREE
    double a3AL[d3A + 5];
    double a3BL[d3B + 5];
...
#endif
#ifdef FIVEBYFIVE
        for (int x = 0; x < d5A + 2; x++) {
            a5AL[x] = 0.0;
            a5AR[x] = 0.0;
        }
        for (int x = 0; x < d5B + 2; x++) {
            a5BL[x] = 0.0;
            a5BR[x] = 0.0;
        }
        for (int x = 0; x < d5C + 2; x++) {
            a5CL[x] = 0.0;
            a5CR[x] = 0.0;
        }
        for (int x = 0; x < d5D + 2; x++) {
            a5DL[x] = 0.0;
            a5DR[x] = 0.0;
        }
        for (int x = 0; x < d5E + 2; x++) {
            a5EL[x] = 0.0;
            a5ER[x] = 0.0;
        }
        for (int x = 0; x < d5F + 2; x++) {
            a5FL[x] = 0.0;
            a5FR[x] = 0.0;
        }
        for (int x = 0; x < d5G + 2; x++) {
            a5GL[x] = 0.0;
            a5GR[x] = 0.0;
        }
        for (int x = 0; x < d5H + 2; x++) {
            a5HL[x] = 0.0;
            a5HR[x] = 0.0;
        }
        for (int x = 0; x < d5I + 2; x++) {
            a5IL[x] = 0.0;
            a5IR[x] = 0.0;
        }
        for (int x = 0; x < d5J + 2; x++) {
            a5JL[x] = 0.0;
            a5JR[x] = 0.0;
        }
        for (int x = 0; x < d5K + 2; x++) {
            a5KL[x] = 0.0;
            a5KR[x] = 0.0;
        }
        for (int x = 0; x < d5L + 2; x++) {
            a5LL[x] = 0.0;
            a5LR[x] = 0.0;
        }
        for (int x = 0; x < d5M + 2; x++) {
            a5ML[x] = 0.0;
            a5MR[x] = 0.0;
        }
        for (int x = 0; x < d5N + 2; x++) {
            a5NL[x] = 0.0;
            a5NR[x] = 0.0;
        }
        for (int x = 0; x < d5O + 2; x++) {
            a5OL[x] = 0.0;
            a5OR[x] = 0.0;
        }
        for (int x = 0; x < d5P + 2; x++) {
            a5PL[x] = 0.0;
            a5PR[x] = 0.0;
        }
        for (int x = 0; x < d5Q + 2; x++) {
            a5QL[x] = 0.0;
            a5QR[x] = 0.0;
        }
        for (int x = 0; x < d5R + 2; x++) {
            a5RL[x] = 0.0;
            a5RR[x] = 0.0;
        }
        for (int x = 0; x < d5S + 2; x++) {
            a5SL[x] = 0.0;
            a5SR[x] = 0.0;
        }
        for (int x = 0; x < d5T + 2; x++) {
            a5TL[x] = 0.0;
            a5TR[x] = 0.0;
        }
        for (int x = 0; x < d5U + 2; x++) {
            a5UL[x] = 0.0;
            a5UR[x] = 0.0;
        }
        for (int x = 0; x < d5V + 2; x++) {
            a5VL[x] = 0.0;
            a5VR[x] = 0.0;
        }
        for (int x = 0; x < d5W + 2; x++) {
            a5WL[x] = 0.0;
            a5WR[x] = 0.0;
        }
        for (int x = 0; x < d5X + 2; x++) {
            a5XL[x] = 0.0;
            a5XR[x] = 0.0;
        }
        for (int x = 0; x < d5Y + 2; x++) {
            a5YL[x] = 0.0;
            a5YR[x] = 0.0;
        }
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0) {
            ...
            if (bez[bez_cycle] > 1.0) { // hit the end point and we do a reverb sample
                ...
                f4AL = (f4AL + f4AL + f4AL + fabs(avg4L)) * 0.25;
                avg4L = f4AL;
                f4DR = (f4DR + f4DR + f4DR + fabs(avg4R)) * 0.25;
                avg4R = f4DR;
                // manipulating deep reverb tail for realism
#endif
#ifdef FIVEBYFIVE
                ...
                f5AL = (f5AL + f5AL + f5AL + fabs(avg5L)) * 0.25;
                avg5L = f5AL;
                f5ER = (f5ER + f5ER + f5ER + fabs(avg5R)) * 0.25;
                avg5R = f5ER;
                // manipulating deep reverb tail for realism
#endif
#ifdef SIXBYSIX
