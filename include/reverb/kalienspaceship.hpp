...
template <typename T>
class kAlienSpaceship final : public Effect<T>
{
    static constexpr int d3A = 2639;
    static constexpr int d3B = 4367;
    static constexpr int d3C = 4370;
    static constexpr int d3D = 2549;
    static constexpr int d3E = 2706;
    static constexpr int d3F = 3376;
    static constexpr int d3G = 2029;
    static constexpr int d3H = 2261;
    static constexpr int d3I = 2712;
    static constexpr int d6A = 1498;
    static constexpr int d6B = 82;
    static constexpr int d6C = 631;
    static constexpr int d6D = 762;
    static constexpr int d6E = 1241;
    static constexpr int d6F = 79;
    static constexpr int d6G = 821;
    static constexpr int d6H = 1315;
    static constexpr int d6I = 2261;
    static constexpr int d6J = 2029;
    static constexpr int d6K = 108;
    static constexpr int d6L = 2712;
    static constexpr int d6M = 305;
    static constexpr int d6N = 671;
    static constexpr int d6O = 13;
    static constexpr int d6P = 913;
    static constexpr int d6Q = 1999;
    static constexpr int d6R = 600;
    static constexpr int d6S = 826;
    static constexpr int d6T = 3376;
    static constexpr int d6U = 969;
    static constexpr int d6V = 2639;
    static constexpr int d6W = 915;
    static constexpr int d6X = 1173;
    static constexpr int d6Y = 1345;
    static constexpr int d6ZA = 4370;
    static constexpr int d6ZB = 4367;
    static constexpr int d6ZC = 2549;
    static constexpr int d6ZD = 227;
    static constexpr int d6ZE = 696;
    static constexpr int d6ZF = 1332;
    static constexpr int d6ZG = 1503;
    static constexpr int d6ZH = 627;
    static constexpr int d6ZI = 322;
    static constexpr int d6ZJ = 451;
    static constexpr int d6ZK = 2706;
    static constexpr int early[] = { 13, 79, 82, 108, 227, 305, 322, 451, 600, 627, 631, 671, 696, 762, 821, 826, 913, 915, 969, 1173, 1241, 1315, 1332, 1345, 1498, 1503, 1999, 2029, 2261, 2549, 2639, 2706, 2712, 3376, 4367, 4370 };
    static constexpr int kNumPrograms = 0;
    static constexpr int kNumInputs = 2;
    static constexpr int kNumOutputs = 2;
    static constexpr unsigned long kUniqueId = 'kals';
    float A;
    float B;
    float C;
    float D;
