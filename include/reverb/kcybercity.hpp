...
template <typename T>
class kCyberCity final : public Effect<T>
{
    static constexpr int d3A = 2114;
    static constexpr int d3B = 3309;
    static constexpr int d3C = 3425;
    static constexpr int d3D = 2083;
    static constexpr int d3E = 2178;
    static constexpr int d3F = 2990;
    static constexpr int d3G = 1880;
    static constexpr int d3H = 1903;
    static constexpr int d3I = 2801;
    static constexpr int d6A = 1903;
    static constexpr int d6B = 19;
    static constexpr int d6C = 23;
    static constexpr int d6D = 29;
    static constexpr int d6E = 830;
    static constexpr int d6F = 1449;
    static constexpr int d6G = 41;
    static constexpr int d6H = 43;
    static constexpr int d6I = 47;
    static constexpr int d6J = 1327;
    static constexpr int d6K = 2178;
    static constexpr int d6L = 1657;
    static constexpr int d6M = 2114;
    static constexpr int d6N = 384;
    static constexpr int d6O = 73;
    static constexpr int d6P = 79;
    static constexpr int d6Q = 3309;
    static constexpr int d6R = 2083;
    static constexpr int d6S = 632;
    static constexpr int d6T = 302;
    static constexpr int d6U = 239;
    static constexpr int d6V = 445;
    static constexpr int d6W = 635;
    static constexpr int d6X = 113;
    static constexpr int d6Y = 127;
    static constexpr int d6ZA = 131;
    static constexpr int d6ZB = 2990;
    static constexpr int d6ZC = 70;
    static constexpr int d6ZD = 1880;
    static constexpr int d6ZE = 151;
    static constexpr int d6ZF = 222;
    static constexpr int d6ZG = 24;
    static constexpr int d6ZH = 2801;
    static constexpr int d6ZI = 460;
    static constexpr int d6ZJ = 3425;
    static constexpr int d6ZK = 181;
    static constexpr int early[] = { 19, 23, 24, 29, 41, 43, 47, 70, 73, 79, 113, 127, 131, 151, 181, 222, 239, 302, 384, 445, 460, 632, 635, 830, 1327, 1449, 1657, 1880, 1903, 2083, 2114, 2178, 2801, 2990, 3309, 3425 };
    static constexpr int kNumPrograms = 0;
    static constexpr int kNumInputs = 2;
    static constexpr int kNumOutputs = 2;
    static constexpr unsigned long kUniqueId = 'kgai';
    float A;
    float B;
    float C;
    double a3AL[d3A + 5];
        ...
        while (--sampleFrames >= 0) {
            ...
            if (bez[bez_cycle] > 1.0) { // hit the end point and we do a reverb sample
                ...
                if (roomTimerL > 19) {
                    roomTimerL = 0;
                    if (roomNoiseL > 0.0) {
                        roomNoiseL -= fabs((fpdL / (double)UINT32_MAX) - 0.5) * 0.08625;
                    }
                    else {
                        roomNoiseL += fabs((fpdL / (double)UINT32_MAX) - 0.5) * 0.08625;
                    }
                    ...
                    roomNoiseL += ((fpdL / (double)UINT32_MAX) - 0.5) * 0.08625;
                }
                ...
                if (roomTimerR > 7) {
                    roomTimerR = 0;
                    if (roomNoiseR > fmin(reg6n + (applyNonlin * 0.00058), regenMax)) {
                        roomNoiseR -= fabs((fpdR / (double)UINT32_MAX) - 0.5) * 0.000021;
                    }
                    else {
                        roomNoiseR += fabs((fpdR / (double)UINT32_MAX) - 0.5) * 0.000021;
                    }
                    ...
                    roomNoiseR += ((fpdR / (double)UINT32_MAX) - 0.5) * 0.000021;
                }
