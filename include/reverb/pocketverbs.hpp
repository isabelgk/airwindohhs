...
constexpr std::string_view k_name{ "PocketVerbs" };
constexpr std::string_view k_short_description{
    "PocketVerbs is my popular old special effects reverbs plugin!"
};
constexpr std::string_view k_long_description{
    "This plugin is a bit of a big deal. It’s been hotly anticipated, and is one of the last two ‘old stock’ plugins (at least, out of my main list) to be brought up to date and ported to VST/Windows/Linux. The other one is Cabs, and I think Cabs isn’t really very good. I’ll put it out anyhow, but I’ve dragged my feet because it’s a pain to work on and it’s not great at ‘being a speaker cab plugin’, not truly special just weird.But this is PocketVerbs, and PocketVerbs IS special. It’s a precursor to what I’m doing with MV, what I’ll do more of in the future… but the reason I dragged my feet on this one is, it’s cumbersome. There’s more code in it than the size of some novels, and I had to port that! It’s not even brilliant code… but it had to be done just as it was, to maintain the tone qualities PocketVerbs has. It’s huge because it has multiple reverbs to switch between, and the way I implemented that was not easy on me. I’ve honored that in the current version.You get chambers, rooms, springs. You get a PaulStretch type effect. You get Zarathustra, which is like that but dark and distant and vast. You get a strange gating effect not present in any other plugin, just as it was: this lets you completely and totally reinvent drum sounds even on a stereo mix. It’s a dual-mono design so you get stereo localization out of the space-ified, gated, reinvented drum sounds. Or, you can try whatever other crazy tricks tickle your fancy.It’s PocketVerbs. It’s here, it’s free, it’s yours. Go bonkers… and have fun."
};
...
template <typename T>
class PocketVerbs final : public Effect<T>
{
    int count;
    double dAR[7];
    double dBR[7];
  ...
  public:
    ...
    constexpr std::string_view get_parameter_name(int index)
    {
        switch (static_cast<params>(index))
        {
            ...
            case kParamB: return "size"; break;
            case kParamC: return "gating"; break;
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        if (savedRoomsize != roomsize) {
            savedRoomsize = roomsize;
            countdown = 26;
        } // kick off the adjustment which will take 26 zippernoise refreshes to complete
        if (countdown > 0) {
            switch (countdown)
            {
                case 1:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayA != count && delayA % count == 0) {
                            delayA += 1;
                            count = 2;
                        }
                    } // try for primeish As
                    if (delayA > maxdelayA) {
                        delayA = maxdelayA; // insanitycheck
                    }
                    for (count = alpAL; count < 15149; count++) {
                        aAL[count] = 0.0;
                    }
                    for (count = outAL; count < 15149; count++) {
                        oAL[count] = 0.0;
                    }
                    break;
                case 2:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayB != count && delayB % count == 0) {
                            delayB += 1;
                            count = 2;
                        }
                    } // try for primeish Bs
                    if (delayB > maxdelayB) {
                        delayB = maxdelayB; // insanitycheck
                    }
                    for (count = alpBL; count < 14617; count++) {
                        aBL[count] = 0.0;
                    }
                    for (count = outBL; count < 14617; count++) {
                        oBL[count] = 0.0;
                    }
                    break;
                case 3:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayC != count && delayC % count == 0) {
                            delayC += 1;
                            count = 2;
                        }
                    } // try for primeish Cs
                    if (delayC > maxdelayC) {
                        delayC = maxdelayC; // insanitycheck
                    }
                    for (count = alpCL; count < 14357; count++) {
                        aCL[count] = 0.0;
                    }
                    for (count = outCL; count < 14357; count++) {
                        oCL[count] = 0.0;
                    }
                    break;
                case 4:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayD != count && delayD % count == 0) {
                            delayD += 1;
                            count = 2;
                        }
                    } // try for primeish Ds
                    if (delayD > maxdelayD) {
                        delayD = maxdelayD; // insanitycheck
                    }
                    for (count = alpDL; count < 13817; count++) {
                        aDL[count] = 0.0;
                    }
                    for (count = outDL; count < 13817; count++) {
                        oDL[count] = 0.0;
                    }
                    break;
                case 5:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayE != count && delayE % count == 0) {
                            delayE += 1;
                            count = 2;
                        }
                    } // try for primeish Es
                    if (delayE > maxdelayE) {
                        delayE = maxdelayE; // insanitycheck
                    }
                    for (count = alpEL; count < 13561; count++) {
                        aEL[count] = 0.0;
                    }
                    for (count = outEL; count < 13561; count++) {
                        oEL[count] = 0.0;
                    }
                    break;
                case 6:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayF != count && delayF % count == 0) {
                            delayF += 1;
                            count = 2;
                        }
                    } // try for primeish Fs
                    if (delayF > maxdelayF) {
                        delayF = maxdelayF; // insanitycheck
                    }
                    for (count = alpFL; count < 13045; count++) {
                        aFL[count] = 0.0;
                    }
                    for (count = outFL; count < 13045; count++) {
                        oFL[count] = 0.0;
                    }
                    break;
                case 7:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayG != count && delayG % count == 0) {
                            delayG += 1;
                            count = 2;
                        }
                    } // try for primeish Gs
                    if (delayG > maxdelayG) {
                        delayG = maxdelayG; // insanitycheck
                    }
                    for (count = alpGL; count < 11965; count++) {
                        aGL[count] = 0.0;
                    }
                    for (count = outGL; count < 11965; count++) {
                        oGL[count] = 0.0;
                    }
                    break;
                case 8:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayH != count && delayH % count == 0) {
                            delayH += 1;
                            count = 2;
                        }
                    } // try for primeish Hs
                    if (delayH > maxdelayH) {
                        delayH = maxdelayH; // insanitycheck
                    }
                    for (count = alpHL; count < 11129; count++) {
                        aHL[count] = 0.0;
                    }
                    for (count = outHL; count < 11129; count++) {
                        oHL[count] = 0.0;
                    }
                    break;
                case 9:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayI != count && delayI % count == 0) {
                            delayI += 1;
                            count = 2;
                        }
                    } // try for primeish Is
                    if (delayI > maxdelayI) {
                        delayI = maxdelayI; // insanitycheck
                    }
                    for (count = alpIL; count < 10597; count++) {
                        aIL[count] = 0.0;
                    }
                    for (count = outIL; count < 10597; count++) {
                        oIL[count] = 0.0;
                    }
                    break;
                case 10:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayJ != count && delayJ % count == 0) {
                            delayJ += 1;
                            count = 2;
                        }
                    } // try for primeish Js
                    if (delayJ > maxdelayJ) {
                        delayJ = maxdelayJ; // insanitycheck
                    }
                    for (count = alpJL; count < 9809; count++) {
                        aJL[count] = 0.0;
                    }
                    for (count = outJL; count < 9809; count++) {
                        oJL[count] = 0.0;
                    }
                    break;
                case 11:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayK != count && delayK % count == 0) {
                            delayK += 1;
                            count = 2;
                        }
                    } // try for primeish Ks
                    if (delayK > maxdelayK) {
                        delayK = maxdelayK; // insanitycheck
                    }
                    for (count = alpKL; count < 9521; count++) {
                        aKL[count] = 0.0;
                    }
                    for (count = outKL; count < 9521; count++) {
                        oKL[count] = 0.0;
                    }
                    break;
                case 12:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayL != count && delayL % count == 0) {
                            delayL += 1;
                            count = 2;
                        }
                    } // try for primeish Ls
                    if (delayL > maxdelayL) {
                        delayL = maxdelayL; // insanitycheck
                    }
                    for (count = alpLL; count < 8981; count++) {
                        aLL[count] = 0.0;
                    }
                    for (count = outLL; count < 8981; count++) {
                        oLL[count] = 0.0;
                    }
                    break;
                case 13:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayM != count && delayM % count == 0) {
                            delayM += 1;
                            count = 2;
                        }
                    } // try for primeish Ms
                    if (delayM > maxdelayM) {
                        delayM = maxdelayM; // insanitycheck
                    }
                    for (count = alpML; count < 8785; count++) {
                        aML[count] = 0.0;
                    }
                    for (count = outML; count < 8785; count++) {
                        oML[count] = 0.0;
                    }
                    break;
                case 14:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayN != count && delayN % count == 0) {
                            delayN += 1;
                            count = 2;
                        }
                    } // try for primeish Ns
                    if (delayN > maxdelayN) {
                        delayN = maxdelayN; // insanitycheck
                    }
                    for (count = alpNL; count < 8461; count++) {
                        aNL[count] = 0.0;
                    }
                    for (count = outNL; count < 8461; count++) {
                        oNL[count] = 0.0;
                    }
                    break;
                case 15:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayO != count && delayO % count == 0) {
                            delayO += 1;
                            count = 2;
                        }
                    } // try for primeish Os
                    if (delayO > maxdelayO) {
                        delayO = maxdelayO; // insanitycheck
                    }
                    for (count = alpOL; count < 8309; count++) {
                        aOL[count] = 0.0;
                    }
                    for (count = outOL; count < 8309; count++) {
                        oOL[count] = 0.0;
                    }
                    break;
                case 16:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayP != count && delayP % count == 0) {
                            delayP += 1;
                            count = 2;
                        }
                    } // try for primeish Ps
                    if (delayP > maxdelayP) {
                        delayP = maxdelayP; // insanitycheck
                    }
                    for (count = alpPL; count < 7981; count++) {
                        aPL[count] = 0.0;
                    }
                    for (count = outPL; count < 7981; count++) {
                        oPL[count] = 0.0;
                    }
                    break;
                case 17:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayQ != count && delayQ % count == 0) {
                            delayQ += 1;
                            count = 2;
                        }
                    } // try for primeish Qs
                    if (delayQ > maxdelayQ) {
                        delayQ = maxdelayQ; // insanitycheck
                    }
                    for (count = alpQL; count < 7321; count++) {
                        aQL[count] = 0.0;
                    }
                    for (count = outQL; count < 7321; count++) {
                        oQL[count] = 0.0;
                    }
                    break;
                case 18:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayR != count && delayR % count == 0) {
                            delayR += 1;
                            count = 2;
                        }
                    } // try for primeish Rs
                    if (delayR > maxdelayR) {
                        delayR = maxdelayR; // insanitycheck
                    }
                    for (count = alpRL; count < 6817; count++) {
                        aRL[count] = 0.0;
                    }
                    for (count = outRL; count < 6817; count++) {
                        oRL[count] = 0.0;
                    }
                    break;
                case 19:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayS != count && delayS % count == 0) {
                            delayS += 1;
                            count = 2;
                        }
                    } // try for primeish Ss
                    if (delayS > maxdelayS) {
                        delayS = maxdelayS; // insanitycheck
                    }
                    for (count = alpSL; count < 6505; count++) {
                        aSL[count] = 0.0;
                    }
                    for (count = outSL; count < 6505; count++) {
                        oSL[count] = 0.0;
                    }
                    break;
                case 20:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayT != count && delayT % count == 0) {
                            delayT += 1;
                            count = 2;
                        }
                    } // try for primeish Ts
                    if (delayT > maxdelayT) {
                        delayT = maxdelayT; // insanitycheck
                    }
                    for (count = alpTL; count < 6001; count++) {
                        aTL[count] = 0.0;
                    }
                    for (count = outTL; count < 6001; count++) {
                        oTL[count] = 0.0;
                    }
                    break;
                case 21:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayU != count && delayU % count == 0) {
                            delayU += 1;
                            count = 2;
                        }
                    } // try for primeish Us
                    if (delayU > maxdelayU) {
                        delayU = maxdelayU; // insanitycheck
                    }
                    for (count = alpUL; count < 5837; count++) {
                        aUL[count] = 0.0;
                    }
                    for (count = outUL; count < 5837; count++) {
                        oUL[count] = 0.0;
                    }
                    break;
                case 22:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayV != count && delayV % count == 0) {
                            delayV += 1;
                            count = 2;
                        }
                    } // try for primeish Vs
                    if (delayV > maxdelayV) {
                        delayV = maxdelayV; // insanitycheck
                    }
                    for (count = alpVL; count < 5501; count++) {
                        aVL[count] = 0.0;
                    }
                    for (count = outVL; count < 5501; count++) {
                        oVL[count] = 0.0;
                    }
                    break;
                case 23:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayW != count && delayW % count == 0) {
                            delayW += 1;
                            count = 2;
                        }
                    } // try for primeish Ws
                    if (delayW > maxdelayW) {
                        delayW = maxdelayW; // insanitycheck
                    }
                    for (count = alpWL; count < 5009; count++) {
                        aWL[count] = 0.0;
                    }
                    for (count = outWL; count < 5009; count++) {
                        oWL[count] = 0.0;
                    }
                    break;
                case 24:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayX != count && delayX % count == 0) {
                            delayX += 1;
                            count = 2;
                        }
                    } // try for primeish Xs
                    if (delayX > maxdelayX) {
                        delayX = maxdelayX; // insanitycheck
                    }
                    for (count = alpXL; count < 4849; count++) {
                        aXL[count] = 0.0;
                    }
                    for (count = outXL; count < 4849; count++) {
                        oXL[count] = 0.0;
                    }
                    break;
                case 25:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayY != count && delayY % count == 0) {
                            delayY += 1;
                            count = 2;
                        }
                    } // try for primeish Ys
                    if (delayY > maxdelayY) {
                        delayY = maxdelayY; // insanitycheck
                    }
                    for (count = alpYL; count < 4295; count++) {
                        aYL[count] = 0.0;
                    }
                    for (count = outYL; count < 4295; count++) {
                        oYL[count] = 0.0;
                    }
                    break;
                case 26:
                    ...
                    for (count = 2; count <= max; count++) {
                        if (delayZ != count && delayZ % count == 0) {
                            delayZ += 1;
                            count = 2;
                        }
                    } // try for primeish Zs
                    if (delayZ > maxdelayZ) {
                        delayZ = maxdelayZ; // insanitycheck
                    }
                    for (count = alpZL; count < 4179; count++) {
                        aZL[count] = 0.0;
                    }
                    for (count = outZL; count < 4179; count++) {
                        oZL[count] = 0.0;
                    }
                    break;
        ...
        if (countdown > 0) {
            switch (countdown)
            {
                case 1:
                    ...
                    for (count = alpAR; count < 15149; count++) {
                        aAR[count] = 0.0;
                    }
                    for (count = outAR; count < 15149; count++) {
                        oAR[count] = 0.0;
                    }
                    break;
                case 2:
                    ...
                    for (count = alpBR; count < 14617; count++) {
                        aBR[count] = 0.0;
                    }
                    for (count = outBR; count < 14617; count++) {
                        oBR[count] = 0.0;
                    }
                    break;
                case 3:
                    ...
                    for (count = alpCR; count < 14357; count++) {
                        aCR[count] = 0.0;
                    }
                    for (count = outCR; count < 14357; count++) {
                        oCR[count] = 0.0;
                    }
                    break;
                case 4:
                    ...
                    for (count = alpDR; count < 13817; count++) {
                        aDR[count] = 0.0;
                    }
                    for (count = outDR; count < 13817; count++) {
                        oDR[count] = 0.0;
                    }
                    break;
                case 5:
                    ...
                    for (count = alpER; count < 13561; count++) {
                        aER[count] = 0.0;
                    }
                    for (count = outER; count < 13561; count++) {
                        oER[count] = 0.0;
                    }
                    break;
                case 6:
                    ...
                    for (count = alpFR; count < 13045; count++) {
                        aFR[count] = 0.0;
                    }
                    for (count = outFR; count < 13045; count++) {
                        oFR[count] = 0.0;
                    }
                    break;
                case 7:
                    ...
                    for (count = alpGR; count < 11965; count++) {
                        aGR[count] = 0.0;
                    }
                    for (count = outGR; count < 11965; count++) {
                        oGR[count] = 0.0;
                    }
                    break;
                case 8:
                    ...
                    for (count = alpHR; count < 11129; count++) {
                        aHR[count] = 0.0;
                    }
                    for (count = outHR; count < 11129; count++) {
                        oHR[count] = 0.0;
                    }
                    break;
                case 9:
                    ...
                    for (count = alpIR; count < 10597; count++) {
                        aIR[count] = 0.0;
                    }
                    for (count = outIR; count < 10597; count++) {
                        oIR[count] = 0.0;
                    }
                    break;
                case 10:
                    ...
                    for (count = alpJR; count < 9809; count++) {
                        aJR[count] = 0.0;
                    }
                    for (count = outJR; count < 9809; count++) {
                        oJR[count] = 0.0;
                    }
                    break;
                case 11:
                    ...
                    for (count = alpKR; count < 9521; count++) {
                        aKR[count] = 0.0;
                    }
                    for (count = outKR; count < 9521; count++) {
                        oKR[count] = 0.0;
                    }
                    break;
                case 12:
                    ...
                    for (count = alpLR; count < 8981; count++) {
                        aLR[count] = 0.0;
                    }
                    for (count = outLR; count < 8981; count++) {
                        oLR[count] = 0.0;
                    }
                    break;
                case 13:
                    ...
                    for (count = alpMR; count < 8785; count++) {
                        aMR[count] = 0.0;
                    }
                    for (count = outMR; count < 8785; count++) {
                        oMR[count] = 0.0;
                    }
                    break;
                case 14:
                    ...
                    for (count = alpNR; count < 8461; count++) {
                        aNR[count] = 0.0;
                    }
                    for (count = outNR; count < 8461; count++) {
                        oNR[count] = 0.0;
                    }
                    break;
                case 15:
                    ...
                    for (count = alpOR; count < 8309; count++) {
                        aOR[count] = 0.0;
                    }
                    for (count = outOR; count < 8309; count++) {
                        oOR[count] = 0.0;
                    }
                    break;
                case 16:
                    ...
                    for (count = alpPR; count < 7981; count++) {
                        aPR[count] = 0.0;
                    }
                    for (count = outPR; count < 7981; count++) {
                        oPR[count] = 0.0;
                    }
                    break;
                case 17:
                    ...
                    for (count = alpQR; count < 7321; count++) {
                        aQR[count] = 0.0;
                    }
                    for (count = outQR; count < 7321; count++) {
                        oQR[count] = 0.0;
                    }
                    break;
                case 18:
                    ...
                    for (count = alpRR; count < 6817; count++) {
                        aRR[count] = 0.0;
                    }
                    for (count = outRR; count < 6817; count++) {
                        oRR[count] = 0.0;
                    }
                    break;
                case 19:
                    ...
                    for (count = alpSR; count < 6505; count++) {
                        aSR[count] = 0.0;
                    }
                    for (count = outSR; count < 6505; count++) {
                        oSR[count] = 0.0;
                    }
                    break;
                case 20:
                    ...
                    for (count = alpTR; count < 6001; count++) {
                        aTR[count] = 0.0;
                    }
                    for (count = outTR; count < 6001; count++) {
                        oTR[count] = 0.0;
                    }
                    break;
                case 21:
                    ...
                    for (count = alpUR; count < 5837; count++) {
                        aUR[count] = 0.0;
                    }
                    for (count = outUR; count < 5837; count++) {
                        oUR[count] = 0.0;
                    }
                    break;
                case 22:
                    ...
                    for (count = alpVR; count < 5501; count++) {
                        aVR[count] = 0.0;
                    }
                    for (count = outVR; count < 5501; count++) {
                        oVR[count] = 0.0;
                    }
                    break;
                case 23:
                    ...
                    for (count = alpWR; count < 5009; count++) {
                        aWR[count] = 0.0;
                    }
                    for (count = outWR; count < 5009; count++) {
                        oWR[count] = 0.0;
                    }
                    break;
                case 24:
                    ...
                    for (count = alpXR; count < 4849; count++) {
                        aXR[count] = 0.0;
                    }
                    for (count = outXR; count < 4849; count++) {
                        oXR[count] = 0.0;
                    }
                    break;
                case 25:
                    ...
                    for (count = alpYR; count < 4295; count++) {
                        aYR[count] = 0.0;
                    }
                    for (count = outYR; count < 4295; count++) {
                        oYR[count] = 0.0;
                    }
                    break;
                case 26:
                    ...
                    for (count = alpZR; count < 4179; count++) {
                        aZR[count] = 0.0;
                    }
                    for (count = outZR; count < 4179; count++) {
                        oZR[count] = 0.0;
                    }
                    break;
            } // end of switch statement
        ...
        while (--sampleFrames >= 0)
        {
            ...
            peakL -= release;
            if (peakL < fabs(inputSampleL * 2.0)) {
                peakL = fabs(inputSampleL * 2.0);
            }
            if (peakL > 1.0) {
                peakL = 1.0;
            }
            peakR -= release;
            if (peakR < fabs(inputSampleR * 2.0)) {
                peakR = fabs(inputSampleR * 2.0);
            }
            if (peakR > 1.0) {
                peakR = 1.0;
            }
