...
class Chamber final : public Effect<T>
{
  ...
  public:
    ...
    T get_parameter_default(int index)
    {
        switch (static_cast<params>(index))
        {
            case kParamA: return 0.35; break;
            case kParamB: return 0.35; break;
            case kParamC: return 0.35; break;
            case kParamD: return 0.35; break;
            case kParamE: return 0.35; break;
    ...
    constexpr std::string_view get_parameter_name(int index)
    {
        switch (static_cast<params>(index))
        {
            ...
            case kParamC: return "liteness"; break;
            case kParamD: return "darkness"; break;
