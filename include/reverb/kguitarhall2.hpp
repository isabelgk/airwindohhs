...
template <typename T>
class kGuitarHall2 final : public Effect<T>
{
    static constexpr int d3A = 874;
    static constexpr int d3B = 1168;
    static constexpr int d3C = 1315;
    static constexpr int d3D = 590;
    static constexpr int d3E = 1060;
    static constexpr int d3F = 1162;
    static constexpr int d3G = 545;
    static constexpr int d3H = 574;
    static constexpr int d3I = 1146;
    static constexpr int d6A = 1315;
    static constexpr int d6B = 32;
    static constexpr int d6C = 459;
    static constexpr int d6D = 97;
    static constexpr int d6E = 358;
    static constexpr int d6F = 65;
    static constexpr int d6G = 47;
    static constexpr int d6H = 67;
    static constexpr int d6I = 1146;
    static constexpr int d6J = 312;
    static constexpr int d6K = 296;
    static constexpr int d6L = 17;
    static constexpr int d6M = 35;
    static constexpr int d6N = 1162;
    static constexpr int d6O = 1060;
    static constexpr int d6P = 355;
    static constexpr int d6Q = 56;
    static constexpr int d6R = 250;
    static constexpr int d6S = 161;
    static constexpr int d6T = 8;
    static constexpr int d6U = 45;
    static constexpr int d6V = 545;
    static constexpr int d6W = 543;
    static constexpr int d6X = 203;
    static constexpr int d6Y = 590;
    static constexpr int d6ZA = 24;
    static constexpr int d6ZB = 121;
    static constexpr int d6ZC = 35;
    static constexpr int d6ZD = 52;
    static constexpr int d6ZE = 874;
    static constexpr int d6ZF = 15;
    static constexpr int d6ZG = 574;
    static constexpr int d6ZH = 343;
    static constexpr int d6ZI = 24;
    static constexpr int d6ZJ = 102;
    static constexpr int d6ZK = 1168;
    static constexpr int early[] = { 8, 15, 17, 24, 24, 32, 35, 35, 45, 47, 52, 56, 65, 67, 97, 102, 121, 161, 203, 250, 296, 312, 343, 355, 358, 459, 543, 545, 574, 590, 874, 1060, 1146, 1162, 1168, 1315 };
    static constexpr int kNumPrograms = 0;
    static constexpr int kNumInputs = 2;
    static constexpr int kNumOutputs = 2;
    static constexpr unsigned long kUniqueId = 'kgti';
    float A;
    float B;
    float C;
    float D;
