...
namespace airwindohhs::kcathedral4 {

constexpr std::string_view k_name{ "kCathedral4" };
...
template <typename T>
class kCathedral4 final : public Effect<T>
{
    static constexpr int predelay = 15000;
    static constexpr int d3A = 2278;
    static constexpr int d3B = 2955;
    static constexpr int d3C = 3113;
    static constexpr int d3D = 2009;
    static constexpr int d3E = 2374;
    static constexpr int d3F = 2671;
    static constexpr int d3G = 1671;
    static constexpr int d3H = 2006;
    static constexpr int d3I = 2534;
    static constexpr int d6A = 102;
    static constexpr int d6B = 444;
    static constexpr int d6C = 1196;
    static constexpr int d6D = 273;
    static constexpr int d6E = 655;
    static constexpr int d6F = 99;
    static constexpr int d6G = 1419;
    static constexpr int d6H = 952;
    static constexpr int d6I = 10;
    static constexpr int d6J = 314;
    static constexpr int d6K = 545;
    static constexpr int d6L = 1387;
    static constexpr int d6M = 2955;
    static constexpr int d6N = 3113;
    static constexpr int d6O = 2534;
    static constexpr int d6P = 2671;
    static constexpr int d6Q = 34;
    static constexpr int d6R = 670;
    static constexpr int d6S = 341;
    static constexpr int d6T = 237;
    static constexpr int d6U = 63;
    static constexpr int d6V = 2009;
    static constexpr int d6W = 2006;
    static constexpr int d6X = 363;
    static constexpr int d6Y = 1107;
    static constexpr int d6ZA = 1500;
    static constexpr int d6ZB = 1491;
    static constexpr int d6ZC = 11;
    static constexpr int d6ZD = 1070;
    static constexpr int d6ZE = 29;
    static constexpr int d6ZF = 2374;
    static constexpr int d6ZG = 592;
    static constexpr int d6ZH = 1671;
    static constexpr int d6ZI = 270;
    static constexpr int d6ZJ = 1632;
    static constexpr int d6ZK = 2278;
    static constexpr int kNumPrograms = 0;
    static constexpr int kNumInputs = 2;
    static constexpr int kNumOutputs = 2;
    static constexpr unsigned long kUniqueId = 'kctk';
    float A;
    float B;
    float C;
    float D;
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0) {
            ...
            if (bez[bez_cycle] > 1.0) { // hit the end point and we do a reverb sample
                ...
                if (freq < 1.0) {
                    double di = fabs(freq * (1.0 + (inputSampleL)));
                    if (di > 1.0) {
                        di = 1.0;
                    }
