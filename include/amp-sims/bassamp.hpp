...
class BassAmp final : public Effect<T>
{
  ...
  public:
    ...
    T get_parameter_default(int index)
    {
        switch (static_cast<params>(index))
        {
            case kParamA: return 0.75; break;
    ...
    constexpr std::string_view get_parameter_name(int index)
    {
        switch (static_cast<params>(index))
        {
            ...
            case kParamB: return "dry"; break;
            case kParamC: return "dub"; break;
            case kParamD: return "sub"; break;
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (fabs(LinputSample) < 1.18e-43) {
                LinputSample = fpdL * 1.18e-43;
            }
            if (fabs(RinputSample) < 1.18e-43) {
                RinputSample = fpdR * 1.18e-43;
            }
            ...
            if (flip)
            {
                ...
                LiirDriveSampleA = (LiirDriveSampleA * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleA;
                correction = LiirDriveSampleA;
                LiirDriveSampleC = (LiirDriveSampleC * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleC;
                correction += LiirDriveSampleC;
                LiirDriveSampleE = (LiirDriveSampleE * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleE;
                correction += LiirDriveSampleE;
                ...
                RiirDriveSampleA = (RiirDriveSampleA * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleA;
                correction = RiirDriveSampleA;
                RiirDriveSampleC = (RiirDriveSampleC * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleC;
                correction += RiirDriveSampleC;
                RiirDriveSampleE = (RiirDriveSampleE * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleE;
                correction += RiirDriveSampleE;
            ...
            {
                tempSample = subtractSample = LataHalfwaySample;
                LiirDriveSampleB = (LiirDriveSampleB * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleB;
                correction = LiirDriveSampleB;
                LiirDriveSampleD = (LiirDriveSampleD * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleD;
                correction += LiirDriveSampleD;
                LiirDriveSampleF = (LiirDriveSampleF * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= LiirDriveSampleF;
                correction += RiirDriveSampleF;
                LataHalfwaySample -= correction;
                LataHalfwayLowpass = subtractSample - LataHalfwaySample;
                tempSample = subtractSample = RataHalfwaySample;
                RiirDriveSampleB = (RiirDriveSampleB * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleB;
                correction = RiirDriveSampleB;
                RiirDriveSampleD = (RiirDriveSampleD * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleD;
                correction += RiirDriveSampleD;
                RiirDriveSampleF = (RiirDriveSampleF * (1.0 - iirAmount)) + (tempSample * iirAmount);
                tempSample -= RiirDriveSampleF;
                correction += RiirDriveSampleF;
                RataHalfwaySample -= correction;
                RataHalfwayLowpass = subtractSample - RataHalfwaySample;
            }
            // highpass section
            if (LataHalfwaySample > 1.0) {
                LataHalfwaySample = 1.0;
            }
            if (LataHalfwaySample < -1.0) {
                LataHalfwaySample = -1.0;
            }
            if (RataHalfwaySample > 1.0) {
                RataHalfwaySample = 1.0;
            }
            if (RataHalfwaySample < -1.0) {
                RataHalfwaySample = -1.0;
            }
            ...
            LiirSampleA = (LiirSampleA * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleA;
            correction = LiirSampleA;
            LiirSampleB = (LiirSampleB * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleB;
            correction += LiirSampleB;
            LiirSampleC = (LiirSampleC * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleC;
            correction += LiirSampleC;
            LiirSampleD = (LiirSampleD * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleD;
            correction += LiirSampleD;
            LiirSampleE = (LiirSampleE * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleE;
            correction += LiirSampleE;
            LiirSampleF = (LiirSampleF * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleF;
            correction += LiirSampleF;
            LiirSampleG = (LiirSampleG * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleG;
            correction += LiirSampleG;
            LiirSampleH = (LiirSampleH * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleH;
            correction += LiirSampleH;
            LiirSampleI = (LiirSampleI * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleI;
            correction += LiirSampleI;
            LiirSampleJ = (LiirSampleJ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleJ;
            correction += LiirSampleJ;
            LiirSampleK = (LiirSampleK * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleK;
            correction += LiirSampleK;
            LiirSampleL = (LiirSampleL * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleL;
            correction += LiirSampleL;
            LiirSampleM = (LiirSampleM * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleM;
            correction += LiirSampleM;
            LiirSampleN = (LiirSampleN * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleN;
            correction += LiirSampleN;
            LiirSampleO = (LiirSampleO * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleO;
            correction += LiirSampleO;
            LiirSampleP = (LiirSampleP * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleP;
            correction += LiirSampleP;
            LiirSampleQ = (LiirSampleQ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleQ;
            correction += LiirSampleQ;
            LiirSampleR = (LiirSampleR * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleR;
            correction += LiirSampleR;
            LiirSampleS = (LiirSampleS * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleS;
            correction += LiirSampleS;
            LiirSampleT = (LiirSampleT * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleT;
            correction += LiirSampleT;
            LiirSampleU = (LiirSampleU * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleU;
            correction += LiirSampleU;
            LiirSampleV = (LiirSampleV * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleV;
            correction += LiirSampleV;
            LiirSampleW = (LiirSampleW * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleW;
            correction += LiirSampleW;
            LiirSampleX = (LiirSampleX * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleX;
            correction += LiirSampleX;
            LiirSampleY = (LiirSampleY * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleY;
            correction += LiirSampleY;
            LiirSampleZ = (LiirSampleZ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= LiirSampleZ;
            correction += LiirSampleZ;
            ...
            RiirSampleA = (RiirSampleA * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleA;
            correction = RiirSampleA;
            RiirSampleB = (RiirSampleB * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleB;
            correction += RiirSampleB;
            RiirSampleC = (RiirSampleC * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleC;
            correction += RiirSampleC;
            RiirSampleD = (RiirSampleD * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleD;
            correction += RiirSampleD;
            RiirSampleE = (RiirSampleE * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleE;
            correction += RiirSampleE;
            RiirSampleF = (RiirSampleF * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleF;
            correction += RiirSampleF;
            RiirSampleG = (RiirSampleG * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleG;
            correction += RiirSampleG;
            RiirSampleH = (RiirSampleH * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleH;
            correction += RiirSampleH;
            RiirSampleI = (RiirSampleI * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleI;
            correction += RiirSampleI;
            RiirSampleJ = (RiirSampleJ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleJ;
            correction += RiirSampleJ;
            RiirSampleK = (RiirSampleK * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleK;
            correction += RiirSampleK;
            RiirSampleL = (RiirSampleL * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleL;
            correction += RiirSampleL;
            RiirSampleM = (RiirSampleM * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleM;
            correction += RiirSampleM;
            RiirSampleN = (RiirSampleN * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleN;
            correction += RiirSampleN;
            RiirSampleO = (RiirSampleO * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleO;
            correction += RiirSampleO;
            RiirSampleP = (RiirSampleP * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleP;
            correction += RiirSampleP;
            RiirSampleQ = (RiirSampleQ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleQ;
            correction += RiirSampleQ;
            RiirSampleR = (RiirSampleR * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleR;
            correction += RiirSampleR;
            RiirSampleS = (RiirSampleS * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleS;
            correction += RiirSampleS;
            RiirSampleT = (RiirSampleT * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleT;
            correction += RiirSampleT;
            RiirSampleU = (RiirSampleU * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleU;
            correction += RiirSampleU;
            RiirSampleV = (RiirSampleV * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleV;
            correction += RiirSampleV;
            RiirSampleW = (RiirSampleW * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleW;
            correction += RiirSampleW;
            RiirSampleX = (RiirSampleX * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleX;
            correction += RiirSampleX;
            RiirSampleY = (RiirSampleY * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleY;
            correction += RiirSampleY;
            RiirSampleZ = (RiirSampleZ * (1.0 - iirHPAmount)) + (tempSample * iirHPAmount);
            tempSample -= RiirSampleZ;
            correction += RiirSampleZ;
            // do the IIR on a dummy sample, and store up the correction in a variable at the same scale as the very low level
            // numbers being used. Don't keep doing it against the possibly high level signal number.
            RinputSample -= correction;
            // apply stored up tiny corrections
