...
{
    const std::string m_name{ "Elation" };
  ...
  public:
    ...
    void process(T** inputs, T** outputs, long sampleFrames) override
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (abSample > previousL) {
                threshSample = previousL;
            }
            else {
                threshSample = abSample;
            }
            // calibrated to match gain through convolution and -0.3 correction
            ...
            if (flip)
            {
                ...
                {
                    if (compAL < 1.0) {
                        compAL += pow((1.0 - compAL) * recoveryspd, 7);
                    }
                }
            }
            else
            {
                ...
                {
                    if (compBL < 1.0) {
                        compBL += pow((1.0 - compBL) * recoveryspd, 7);
                    }
                }
            }
            previousL = abSample;
            abSample = fabs(inputSampleR);
            if (abSample > previousR) {
                threshSample = previousR;
            }
            else {
                threshSample = abSample;
            }
            ...
            if (flip)
            {
                ...
                {
                    if (compAR < 1.0) {
                        compAR += pow((1.0 - compAR) * recoveryspd, 7);
                    }
                }
            }
            else
            {
                ...
                {
                    if (compBR < 1.0) {
                        compBR += pow((1.0 - compBR) * recoveryspd, 7);
                    }
                }
            }
            previousR = abSample;
            ...
            abSample = fabs(inputSampleL);
            if (abSample > previousBL) {
                threshSample = previousBL;
            }
            else {
                threshSample = abSample;
            }
            ...
            if (flip)
            {
                ...
                {
                    if (compCL < 1.0) {
                        compCL += pow((1.0 - compCL) * recoveryspd, 7);
                    }
                }
            }
            else
            {
                ...
                {
                    if (compDL < 1.0) {
                        compDL += pow((1.0 - compDL) * recoveryspd, 7);
                    }
                }
            }
            previousBL = abSample;
            ...
            abSample = fabs(inputSampleR);
            if (abSample > previousBR) {
                threshSample = previousBR;
            }
            else {
                threshSample = abSample;
            }
            ...
            if (flip)
            {
                ...
                {
                    if (compCR < 1.0) {
                        compCR += pow((1.0 - compCR) * recoveryspd, 7);
                    }
                }
            }
            else
            {
                ...
                {
                    if (compDR < 1.0) {
                        compDR += pow((1.0 - compDR) * recoveryspd, 7);
                    }
                }
            }
            previousBR = abSample;
