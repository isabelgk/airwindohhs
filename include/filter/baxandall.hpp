...
{
    const std::string m_name{ "Baxandall" };
  ...
  public:
    ...
    std::string get_parameter_display(int index) override
    {
        switch (static_cast<params>(index))
        {
            case kParamA: return std::to_string((A * 30.0) - 15.0);
            case kParamB: return std::to_string((B * 30.0) - 15.0);
            case kParamC: return std::to_string((C * 30.0) - 15.0);
