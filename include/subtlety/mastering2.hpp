...
template <typename T>
class Mastering2 final : public Effect<T>
{
    float A;
    float B;
    float C;
  ...
  public:
    ...
    {
        switch (static_cast<params>(index)) {
            case kParamA: return "sidepas"; break;
            case kParamB: return "glue"; break;
            case kParamC: return "scope"; break;
            case kParamD: return "skronk"; break;
            case kParamE: return "girth"; break;
            case kParamF: return "drive"; break;
            case kParamG: return "dither"; break;
