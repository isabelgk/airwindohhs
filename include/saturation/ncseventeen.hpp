...
{
    const std::string m_name{ "NCSeventeen" };
  ...
  public:
    ...
    void process(T** inputs, T** outputs, long sampleFrames) override
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (minusSampleL > maxfeedBass) {
                minusSampleL = maxfeedBass;
            }
            if (plusSampleL > maxfeedBass) {
                plusSampleL = maxfeedBass;
            }
            if (plusSampleL < -maxfeedBass) {
                plusSampleL = -maxfeedBass;
            }
            ...
            if (lowSampleL > distSampleL) {
                basslevL += (minusSampleL * addBassBuss);
            }
            if (lowSampleL < -distSampleL) {
                basslevL -= (plusSampleL * addBassBuss);
            }
            if (basslevL > 1.0) {
                basslevL = 1.0;
            }
            ...
            if (minusSampleR > maxfeedBass) {
                minusSampleR = maxfeedBass;
            }
            if (plusSampleR > maxfeedBass) {
                plusSampleR = maxfeedBass;
            }
            if (plusSampleR < -maxfeedBass) {
                plusSampleR = -maxfeedBass;
            }
            ...
            if (lowSampleR > distSampleR) {
                basslevR += (minusSampleR * addBassBuss);
            }
            if (lowSampleR < -distSampleR) {
                basslevR -= (plusSampleR * addBassBuss);
            }
            if (basslevR > 1.0) {
                basslevR = 1.0;
            }
            ...
            if (minusSampleL > maxfeedTreb) {
                minusSampleL = maxfeedTreb;
            }
            if (plusSampleL > maxfeedTreb) {
                plusSampleL = maxfeedTreb;
            }
            if (plusSampleL < -maxfeedTreb) {
                plusSampleL = -maxfeedTreb;
            }
            ...
            if (highSampleL > distSampleL) {
                treblevL += (minusSampleL * addTrebBuss);
            }
            if (highSampleL < -distSampleL) {
                treblevL -= (plusSampleL * addTrebBuss);
            }
            if (treblevL > 1.0) {
                treblevL = 1.0;
            }
            ...
            if (minusSampleR > maxfeedTreb) {
                minusSampleR = maxfeedTreb;
            }
            if (plusSampleR > maxfeedTreb) {
                plusSampleR = maxfeedTreb;
            }
            if (plusSampleR < -maxfeedTreb) {
                plusSampleR = -maxfeedTreb;
            }
            ...
            if (highSampleR > distSampleR) {
                treblevR += (minusSampleR * addTrebBuss);
            }
            if (highSampleR < -distSampleR) {
                treblevR -= (plusSampleR * addTrebBuss);
            }
            if (treblevR > 1.0) {
                treblevR = 1.0;
            }
            ...
            if (minusSampleL > maxfeed) {
                minusSampleL = maxfeed;
            }
            if (plusSampleL > maxfeed) {
                plusSampleL = maxfeed;
            }
            if (plusSampleL < -maxfeed) {
                plusSampleL = -maxfeed;
            ...
            if (inputSampleL > distSampleL) {
                cheblevL += (minusSampleL * addShortBuss);
            }
            if (inputSampleL < -distSampleL) {
                cheblevL -= (plusSampleL * addShortBuss);
            }
            if (cheblevL > 1.0) {
                cheblevL = 1.0;
            }
            ...
            if (minusSampleR > maxfeed) {
                minusSampleR = maxfeed;
            }
            if (plusSampleR > maxfeed) {
                plusSampleR = maxfeed;
            }
            if (plusSampleR < -maxfeed) {
                plusSampleR = -maxfeed;
            ...
            if (inputSampleR > distSampleR) {
                cheblevR += (minusSampleR * addShortBuss);
            }
            if (inputSampleR < -distSampleR) {
                cheblevR -= (plusSampleR * addShortBuss);
            }
            if (cheblevR > 1.0) {
                cheblevR = 1.0;
            }
            ...
            if (inputSampleL > 0.95) {
                inputSampleL = 0.95;
            }
            if (inputSampleL < -0.95) {
                inputSampleL = -0.95;
            }
            if (inputSampleR > 0.95) {
                inputSampleR = 0.95;
            }
            if (inputSampleR < -0.95) {
                inputSampleR = -0.95;
