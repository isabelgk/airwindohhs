...
class DitherFloat final : public Effect<T>
{
  ...
  public:
    ...
    constexpr std::string_view get_parameter_name(int index)
    {
        switch (static_cast<params>(index))
        {
            case kParamA: return "offset"; break;
            case kParamB: return "dither"; break;
