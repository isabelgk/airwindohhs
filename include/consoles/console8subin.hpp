...
namespace airwindohhs::console8subin {

constexpr std::string_view k_name{ "Console8SubIn" };
...
template <typename T>
class Console8SubIn final : public Effect<T>
{
    double iirAL;
    double iirBL;
    double iirAR;
  ...
  public:
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (softL[9] > 0.73824539) {
                inputSampleL = softL[4] + (fabs(softL[4]) * sin(softL[9] - 0.73824539) * 0.26175461);
            }
            if (-softL[9] > 0.73824539) {
                inputSampleL = softL[4] - (fabs(softL[4]) * sin(-softL[9] - 0.73824539) * 0.26175461);
            }
            ...
            if (softR[9] > 0.73824539) {
                inputSampleR = softR[4] + (fabs(softR[4]) * sin(softR[9] - 0.73824539) * 0.26175461);
            }
            if (-softR[9] > 0.73824539) {
                inputSampleR = softR[4] - (fabs(softR[4]) * sin(-softR[9] - 0.73824539) * 0.26175461);
            }
