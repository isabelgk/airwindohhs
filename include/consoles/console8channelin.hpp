...
namespace airwindohhs::console8channelin {

constexpr std::string_view k_name{ "Console8ChannelIn" };
...
template <typename T>
class Console8ChannelIn final : public Effect<T>
{
    double iirAL;
    double iirBL;
    double iirAR;
  ...
  public:
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (softL[9] > 0.91416342) {
                inputSampleL = softL[4] + (fabs(softL[4]) * sin(softL[9] - 0.91416342) * 0.08583658);
            }
            if (-softL[9] > 0.91416342) {
                inputSampleL = softL[4] - (fabs(softL[4]) * sin(-softL[9] - 0.91416342) * 0.08583658);
            }
            ...
            if (softR[9] > 0.91416342) {
                inputSampleR = softR[4] + (fabs(softR[4]) * sin(softR[9] - 0.91416342) * 0.08583658);
            }
            if (-softR[9] > 0.91416342) {
                inputSampleR = softR[4] - (fabs(softR[4]) * sin(-softR[9] - 0.91416342) * 0.08583658);
            }
