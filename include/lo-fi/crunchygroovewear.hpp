...
class CrunchyGrooveWear final : public Effect<T>
{
  ...
  public:
    ...
    T get_parameter_default(int index)
    {
        switch (static_cast<params>(index))
        {
            case kParamA: return 0.064; break;
    ...
    constexpr std::string_view get_parameter_name(int index)
    {
        switch (static_cast<params>(index))
        {
            ...
            case kParamB: return "apply"; break;
    ...
    void process(T** inputs, T** outputs, long sampleFrames)
    {
        ...
        while (--sampleFrames >= 0)
        {
            ...
            if (aWet > 0.0) {
                ...
                aMidL[2] = aMidL[1];
                aMidL[1] = aMidL[0];
                aMidL[0] = accumulatorSampleL = (inputSampleL - aMidPrevL);
                ...
                aMidR[2] = aMidR[1];
                aMidR[1] = aMidR[0];
                aMidR[0] = accumulatorSampleR = (inputSampleR - aMidPrevR);
                // this is different from Aura because that is accumulating rates of change OF the rate of change
                // this is just averaging slews directly, and we have two stages of it.
            ...
            if (bWet > 0.0) {
                ...
                bMidL[2] = bMidL[1];
                bMidL[1] = bMidL[0];
                bMidL[0] = accumulatorSampleL = (inputSampleL - bMidPrevL);
                accumulatorSampleL *= fMid[0];
                ...
                bMidR[2] = bMidR[1];
                bMidR[1] = bMidR[0];
                bMidR[0] = accumulatorSampleR = (inputSampleR - bMidPrevR);
                accumulatorSampleR *= fMid[0];
            ...
            if (cWet > 0.0) {
                ...
                cMidL[2] = cMidL[1];
                cMidL[1] = cMidL[0];
                cMidL[0] = accumulatorSampleL = (inputSampleL - cMidPrevL);
                accumulatorSampleL *= fMid[0];
                ...
                cMidR[2] = cMidR[1];
                cMidR[1] = cMidR[0];
                cMidR[0] = accumulatorSampleR = (inputSampleR - cMidPrevR);
                accumulatorSampleR *= fMid[0];
            ...
            if (dWet > 0.0) {
                ...
                dMidL[2] = dMidL[1];
                dMidL[1] = dMidL[0];
                dMidL[0] = accumulatorSampleL = (inputSampleL - dMidPrevL);
                accumulatorSampleL *= fMid[0];
                ...
                dMidR[2] = dMidR[1];
                dMidR[1] = dMidR[0];
                dMidR[0] = accumulatorSampleR = (inputSampleR - dMidPrevR);
                accumulatorSampleR *= fMid[0];
