...
class Test final : public Effect<float>
{
  ...
  public:
    ...
    std::string get_parameter_display(int index) override
    {
        ...
        {
            case kParamA:
                return std::to_string((A * 2.0));
            case kParamB:
                return std::to_string(B);
            case kParamC:
                return std::to_string(C * 2.0);
            case kParamD:
                return std::to_string(D);
            case kParamE:
                return std::to_string(E * 2.0);
            case kParamF:
                return std::to_string(F * 2.0);
            default:
                break;
        }
        return {};
    ...
    void process(float** inputs, float** outputs, long sampleframes) override
    {
        ...
        while (--sampleframes >= 0)
        {
            ...
            inputSampleL =
                sin(inputSampleL * fabs(inputSampleL)) / ((fabs(inputSampleL) == 0.0) ? 1 : fabs(inputSampleL));
            inputSampleR =
                sin(inputSampleR * fabs(inputSampleR)) / ((fabs(inputSampleR) == 0.0) ? 1 : fabs(inputSampleR));
            ...
            if (intensityA != 0.0)
            {
                ...
                tempL -= (((pL[count] - pL[count + 1]) - (pL[count + 1] - pL[count + 2])) / 50);
                // interpolation hacks 'r us
                ...
                tempR -= (((pR[count] - pR[count + 1]) - (pR[count + 1] - pR[count + 2])) / 50);
                // interpolation hacks 'r us
